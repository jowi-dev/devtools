-- Soft Light Theme - Easy on the eyes with excellent readability
...
function M.setup()
  ...
  local colors = {
    -- Background shades (warm off-white)
    bg0 = '#f8f6f1',      -- Main background
    bg1 = '#f0ede5',      -- Slightly darker
    bg2 = '#e8e4db',      -- Line numbers, folds
    bg3 = '#d8d4cb',      -- Visual selection

    -- Foreground shades (warm gray-brown)
    fg0 = '#3a3530',      -- Main text
    fg1 = '#5a534d',      -- Comments
    fg2 = '#7a736d',      -- Subtle text

    -- Syntax colors (muted, natural)
    red = '#b05a5a',      -- Strings, errors
    orange = '#c07048',   -- Numbers, constants
    yellow = '#a89050',   -- Functions
    green = '#6b9070',    -- Keywords, types
    cyan = '#5b9090',     -- Special identifiers
    blue = '#608baa',     -- Methods, builtins
    purple = '#9078a0',   -- Variables
    magenta = '#a86888',  -- Preprocessor

    -- UI elements
    border = '#c8c4bb',
    line_highlight = '#f4f2ea',
    cursor_line = '#efeee8',
    cursor = '#d46a6a',     -- Coral/salmon cursor for visibility
    match = '#e8d090',
    diff_add = '#d5e8d5',
    diff_change = '#e8e0c8',
    diff_delete = '#f0d8d8',
